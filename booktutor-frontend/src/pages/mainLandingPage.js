        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-lg-10 text-center">
              <h1>
                <strong>About TutorFinder</strong>
              </h1>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 mr-auto d-flex align-items-center ">
              <div>
                ...
                <p>
                  {" "}
                  Discover skilled tutors tailored to your needs, with
                  transparent profiles and user reviews for informed decisions.
                </p>
                <p>
                  Enjoy flexible scheduling and online sessions for convenient,
                  global learning. Our user-friendly interface ensures a
                  seamless experience, prioritizing safety and security. Empower
                  your academic success with TutorFinder.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="row align-items-stretch">
            <div class="col-lg-4 col-md-6 mb-5">
              <div class="post-entry-1 h-100 person-1">
                <div className="d-flex justify-content-center">
                  <img src={PersonOne} alt="Image" class="img-fluid" />
                </div>
            ...
            <div class="col-lg-4 col-md-6 mb-5">
              <div class="post-entry-1 h-100 person-1">
                <div className="d-flex justify-content-center">
                  <img src={PersonTwo} alt="Image" class="img-fluid" />
                </div>
            ...
            <div class="col-lg-4 col-md-6 mb-5">
              <div class="post-entry-1 h-100 person-1">
                <div className="d-flex justify-content-center">
                  <img src={PersonThree} alt="Image" class="img-fluid" />
                </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 d-flex justify-content-center mt-4">
              <div className="w-50">
                ...
                <p>
                  {" "}
                  At TutorFinder, our mission is to empower learners by
                  facilitating meaningful connections between students and
                  expert tutors.
                </p>
                <p>
                  We strive to create a dynamic learning ecosystem that
                  transcends geographical boundaries, fostering global
                  collaboration. Our commitment is to provide accessible,
                  personalized education, enabling every student to achieve
        ...
        <div class="container">
          <div class="row">
            <div class="">
              ...
              <p className="mb-0 fw-normal fs-4" style={{ color: "#b7aaaa" }}>
                At TutorFinder, our mission is to empower learners by
                facilitating meaningful connections between students and expert
                tutors{" "}
              </p>
              <ul class="list-unstyled social mt-3 d-flex gap-3 alin-items-center">
                <li>
                  ...
                  >
                    <FaFacebook color="#fff" fontSize={20} />
                  </a>
                </li>
                <li>
                  <a
                  ...
                  >
                    <CiInstagram color="#fff" fontSize={20} />
                  </a>
                </li>
                <li>
                  <a
                  ...
                  >
                    <CiTwitter color="#fff" fontSize={20} />
                  </a>
                </li>
                <li>
                  <a
                  ...
                  >
                    <CiLinkedin color="#fff" fontSize={20} />
                  </a>
                </li>
              </ul>
            </div>
