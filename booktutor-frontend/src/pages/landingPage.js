...
const LandingPage = () => {
  return (
    <>
      ...
      <div
        class="jumbotron text-center d-flex flex-column gap-2 "
        style={{ background: "#f4511e", padding: "30px", color: "#fff" }}
      >
        <h1>TutorFinder A</h1>
        ...
        <div class="row">
          <div class="col-sm-8">
            ...
            <p>
              ...
              aliquip ex ea commodo consequat. Discover skilled tutors tailored
              to your needs, with transparent profiles and user reviews for
              informed decisions. Enjoy flexible scheduling and online sessions
              for convenient, global learning. Our user-friendly interface
              ensures a seamless experience, prioritizing safety and security.
              Empower your academic success with TutorFinder.
            </p>
            <br />
        ...
        <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <p>
              ...
              laboris nisi ut aliquip ex ea commodo consequat. At TutorFinder,
              our mission is to empower learners by facilitating meaningful
              connections between students and expert tutors. We strive to
              create a dynamic learning ecosystem that transcends geographical
              boundaries, fostering global collaboration. Our commitment is to
              provide accessible, personalized education, enabling every student
