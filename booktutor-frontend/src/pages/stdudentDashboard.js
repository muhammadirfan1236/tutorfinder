...
const StudentDashboard = () => {
  ...
  const teachersData = () => {
    axios
      .get(
        `${process.env.REACT_APP_BASE_URL}/api/teachers/all?subject=${subject}`
      )
      .then((res) => {
        console.log("abc", res);
  ...
  const singleTeacherData = (teacherId) => {
    axios
      .get(`${process.env.REACT_APP_BASE_URL}/api/teachers/get/${teacherId}`)
      .then((res) => {
        console.log("abc", res);
  ...
  return (
    <>
      <div
        class="offcanvas offcanvas-end fs-5"
        tabindex="-1"
        id="offcanvasExample"
                          ...
                          <td>
                            ...
                            >
                              <FaEye
                                ...
                                onClick={() => singleTeacherData(item._id)}
                              />
                            </a>
                          </td>
                        </tr>
